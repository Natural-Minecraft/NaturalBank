...
public class NBTaskManager {

    public static final String INTEREST_TASK = "interest", MONEY_SAVING_TASK = "money_saving",
            BANKTOP_BROADCAST_TASK = "banktop_broadcast";
