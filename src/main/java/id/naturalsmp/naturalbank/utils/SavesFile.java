...
public class SavesFile {
    ...
    public static File getFile() {
        return NaturalBank.INSTANCE().getConfigs().getFile(SAVES_FILE_NAME);
    }

    public static FileConfiguration getConfig() {
        return NaturalBank.INSTANCE().getConfigs().getConfig(SAVES_FILE_NAME);
    }
    ...
    public static void set(String path, Object object) {
        ...
        if (!file.exists())
            try {
                ...
                NBLogger.Console.warn("Could not create saves.yml file: " + e.getMessage());
            }
        ...
        try {
            ...
            NBLogger.Console.warn("Could not save saves.yml file: " + e.getMessage());
        }
    }
}
