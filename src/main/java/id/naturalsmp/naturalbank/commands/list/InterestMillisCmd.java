...
public class InterestMillisCmd extends NBCommand {
    ...
    public NBCmdExecution onExecution(CommandSender s, String[] args) {
        ...
        return new NBCmdExecution() {
            @Override
            public void execute() {
                NBMessages.sendIdentifier(s, "Interest-Time", "%time%$" + NaturalBank.INSTANCE().getInterest().getInterestCooldownMillis());
            }
        };
    }
