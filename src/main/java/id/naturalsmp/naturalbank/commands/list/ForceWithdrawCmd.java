...
public class ForceWithdrawCmd extends NBCommand {
    ...
    public NBCmdExecution onExecution(CommandSender s, String[] args) {
        ...
        if (!BankUtils.exist(bank)) return NBCmdExecution.invalidExecution();
    ...
    public List<String> tabCompletion(CommandSender s, String[] args) {
        ...
        if (args.length == 3)
            return NBArgs.getArgs(args, "1", "2", "3", "10%", "20%", "custom");
